...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.200012, 342.333313, 338.0, 184.0 ],
					"prototypename" : "pixl",
					"varname" : "cyclr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 355.866669, 757.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo[2]",
					"viewvisibility" : 1
				}
...
,
					...
					"patching_rect" : [ 356.200012, 581.0, 475.666656, 155.033325 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 356.200012, 540.533325, 198.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1161.0, 150.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo[1]",
					"viewvisibility" : 1
				}
...
,
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"patching_rect" : [ 1048.199951, 16.650002, 221.0, 39.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 854.0, 494.0, 330.0, 290.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 854.0, 355.0, 388.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "mappr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 853.999939, 140.0, 248.0, 190.0 ],
					"prototypename" : "pixl",
					"varname" : "patternizr",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 1037.199951, 87.0, 112.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 888.400024, 87.0, 96.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.399994, 11.0, 148.0, 112.0 ],
					"prototypename" : "pixl",
					"varname" : "twiddlr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 137.0, 148.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 137.0, 283.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 137.0, 230.149994, 186.399994, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 7371.929688, "ticks" ],
...
,
					"patching_rect" : [ 304.399994, 176.149994, 244.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.9, 16.650002, 210.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.9, 60.150002, 210.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.999992, 105.649994, 206.0, 22.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-11::obj-7" : [ "live.toggle", "live.toggle", 0 ],
			"obj-20::obj-29" : [ "live.toggle[6]", "live.toggle", 0 ],
			"obj-7::obj-49" : [ "pictctrl[23]", "pictctrl", 0 ],
			"obj-11::obj-85" : [ "number[2]", "number[1]", 0 ],
			"obj-7::obj-1" : [ "range[6]", "range", 0 ],
			"obj-11::obj-67" : [ "pictctrl[170]", "pictctrl[1]", 0 ],
			"obj-20::obj-125" : [ "pictctrl[271]", "pictctrl[1]", 0 ],
			"obj-12::obj-56" : [ "OutputChannel[2]", "OutputChannel", 0 ],
			"obj-7::obj-59" : [ "FreqMode[25]", "FreqMode", 0 ],
			"obj-20::obj-44" : [ "z scale", "z scale", 0 ],
			"obj-12::obj-55" : [ "DSP[2]", "DSP", 0 ],
			"obj-12::obj-52" : [ "Level[2]", "Level", 0 ],
			"obj-11::obj-109" : [ "pictctrl[164]", "pictctrl[1]", 0 ],
			"obj-16::obj-43" : [ "pictctrl[95]", "pictctrl[1]", 0 ],
			"obj-20::obj-131" : [ "pictctrl[266]", "pictctrl[1]", 0 ],
			"obj-11::obj-22" : [ "speed[5]", "speed", 0 ],
			"obj-20::obj-55" : [ "y offest", "y offset", 0 ],
			"obj-11::obj-10" : [ "smoothing", "smoothing", 0 ],
			"obj-20::obj-129" : [ "pictctrl[267]", "pictctrl[1]", 0 ],
			"obj-11::obj-94" : [ "pictctrl[169]", "pictctrl[1]", 0 ],
			"obj-11::obj-41" : [ "number[3]", "number", 0 ],
			"obj-16::obj-65" : [ "speed[4]", "speed", 0 ],
			"obj-20::obj-40" : [ "table size", "table size", 0 ],
			"obj-11::obj-113" : [ "pictctrl[163]", "pictctrl[1]", 0 ],
			"obj-4::obj-56" : [ "OutputChannel[1]", "OutputChannel", 0 ],
			"obj-7::obj-21" : [ "FreqMode[23]", "FreqMode", 0 ],
			"obj-7::obj-35" : [ "umenu[18]", "umenu", 0 ],
			...
			"obj-11::obj-30" : [ "pictctrl[166]", "pictctrl[1]", 0 ],
			"obj-2::obj-52" : [ "Level", "Level", 0 ],
			"obj-7::obj-12" : [ "pictctrl[22]", "pictctrl", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bp.Stereo.maxpat",
